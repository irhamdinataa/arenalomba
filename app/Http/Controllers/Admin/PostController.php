...
class PostController extends Controller
{
                    ...
                    return Auth::user()->roles == 'Administrator'? '
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu animated--fade-in-up" aria-labelledby="dropdownFadeInUp">
                                <a class="dropdown-item" href="' . route('post-detail', $item->slug) . '" target="_blank">Detail</a>
                                <a class="dropdown-item" href="' . route('post.edit', $item->id) . '">Ubah</a>
                                <form action="' . route('post.destroy', $item->id) . '" method="POST" id="deleteForm'.$item->id.'">
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
                    ->route('post.index')
                    ->with('success', 'Sukses! Artikel Berhasil Disimpan');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()
                    ...
                    ->with('success', 'Sukses! Artikel Berhasil Diubah');
    }
