    ...
    <div class="container">
        ...
        <div class="breadcrumb">
            <a href="{{ route('home') }}" rel="nofollow">Beranda</a>
                <span></span>
            <a href="{{ route('video-home.index') }}" rel="nofollow">Video</a>
                ...
                <div class="loop-grid row">
                    ...
                    <article class="col-lg-6 mb-50 animate-conner">
                        ...
                        <div class="post-content">
                            ...
                            <h3 class="post-title">
                                <a href="{{ route('video-home-detail', $item->slug) }}">{{ $item->post_title; }}</a>
                            </h3>
                                ...
                                <li class="mb-30">
                                    <div class="d-flex">
                                        <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                                            <a href="{{ route('video-home-detail', $latest->slug) }}">
                                                <img src="https://img.youtube.com/vi/{{ $item->embed_link }}/hqdefault.jpg" alt="Cover">
                                            </a>
                                        </div>
                                        <div class="post-content media-body">
                                            <div class="entry-meta meta-0 mb-10">
                                                ...
                                                @else
                                                    <a href="{{ route('video-category', $latest->category->slug) }}">
                                                        <span class="post-cat background1 color-white">
