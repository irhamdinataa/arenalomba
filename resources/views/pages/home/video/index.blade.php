...
<div class="archive-header text-center mt-40">
    <div class="container">
        <h2><span class="color2">Video</span></h2>
                    ...
                    <article class="col-lg-6 mb-50 animate-conner">
                        ...
                        <div class="post-content">
                            <div class="entry-meta meta-0 font-small mb-15">
                                @php
                                    $sc = App\Models\CategoryVideo::where('id', $item->sub_categories)->first();
                                @endphp
                                    ...
                                    <div class="d-flex">
                                        <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                                            <a href="{{ route('video-home-detail', $latest->slug) }}">
                                                <img src="https://img.youtube.com/vi/{{ $latest->embed_link }}/hqdefault.jpg" alt="Cover">
                                            </a>
                                        </div>
