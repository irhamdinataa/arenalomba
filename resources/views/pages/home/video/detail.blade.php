        ...
        <div class="row">
            <div class="col-lg-8 col-md-12 col-sm-12">
                <div class="entry-header entry-header-1 mb-30">
                    <div class="entry-meta meta-0 font-small mb-15">
                        <ul class="breadcrumb">
                            ...
                            <li><a href="{{ route('video-home.index') }}">Video</a></li>
                            <li>{{ $post->post_title; }}</li>
                        </ul>
                    </div>
                    <h1 class="post-title">
                        <a href="{{ route('video-home-detail', $post->slug) }}">{{ $post->post_title; }}</a>
                    </h1>
                ...
                <figure class="single-thumnail">
                    <div class="featured-slider-1 border-radius-5">
                        <div class="featured-slider-1-items">
                            <div class="slider-single video-container">
                                <iframe 
                                    src="https://www.youtube.com/embed/{{ $post->embed_link }}"
                                    loading="lazy" 
                ...
                <div class="entry-bottom mt-50 mb-30">
                    <div class="tags">
                        @foreach ($post->tag as $item)
                            <a href="{{ route('video-tag', $item->slug) }}" rel="tag">{{ $item->name; }}</a>
                        @endforeach
                    </div>
                </div>
                <div class="bt-1 border-color-1 mt-30 mb-30"></div>
                ...
                <div class="related-posts">
                    <h3 class="mb-30">Video Terkait</h3>
                    <div class="loop-list">
                        @php
                            $related=1;
                        @endphp
                        ...
                        <article class="row mb-30">
                            <div class="col-md-4">
                                <div class="post-thumb position-relative thumb-overlay">
                                    <div class="img-hover-slide border-radius-5 position-relative" style="background-image: url(https://img.youtube.com/vi/{{ $item->embed_link }}/hqdefault.jpg">
                                        <a class="img-link" href="{{ route('video-home-detail', $item->slug) }}"></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-8 align-center-vertical">
                                <div class="post-content">
                                    <div class="entry-meta meta-0 font-small mb-15">
                                        @php
                                            $sc = App\Models\CategoryCourse::where('id', $item->sub_categories)->first();
                                        @endphp
                                        @if ($item->sub_categories != NULL)
                                            <a href="{{ route('video-category', $sc->slug) }}">
                                                <span class="post-cat background{{ $related++; }} color-white">
                                                    {{ $sc->name; }}
                                                </span>
                                            </a>
                                        @else
                                            <a href="{{ route('video-category', $item->category->slug) }}">
                                                <span class="post-cat background{{ $related++; }} color-white">
                                                    {{ $item->category->name; }}
                                                </span>
                                            </a>
                                    ...
                                    <h4 class="post-title">
                                        <a href="{{ route('video-home-detail', $item->slug) }}">
                                            {{ $item->post_title }}
                                        </a>
                                    </h4>
                                    <div class="entry-meta meta-1 font-small color-grey mt-15 mb-15">
                ...
                <div class="widget-area pl-30">
                    ...
                    <div class="sidebar-widget widget_alitheme_lastpost mb-50">
                        <div class="widget-header position-relative mb-20 pb-10">
                            <h5 class="widget-title mb-10">Video Terbaru</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 sm-grid-content mb-30">
                                <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                    <a href="{{ route('video-home-detail', $item->slug) }}">
                                        <img src="https://img.youtube.com/vi/{{ $item->embed_link }}/hqdefault.jpg" alt="">
                                    </a>
                                </div>
