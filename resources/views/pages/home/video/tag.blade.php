        ...
        <div class="row">
            <div class="col-lg-8 col-md-12 col-sm-12">
                ...
                <div class="loop-grid row">
                    @foreach ($tag_video_video as $item)                  
                    <article class="col-lg-6 mb-50 animate-conner">
                        ...
                        <div class="post-content">
                            <div class="entry-meta meta-0 font-small mb-15">
                                <a href="{{ route('video-category', $item->category_slug) }}">
                                    ...
                                    <div class="d-flex">
                                        <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                                            <a href="{{ route('video-home-detail', $latest->slug) }}">
                                                <img src="https://img.youtube.com/vi/{{ $latest->embed_link }}/hqdefault.jpg" alt="">
                                            </a>
                                        </div>
