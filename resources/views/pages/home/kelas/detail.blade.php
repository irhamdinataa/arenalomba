        ...
        <div class="row">
            <div class="col-lg-8 col-md-12 col-sm-12">
                <div class="entry-header entry-header-1 mb-30">
                    ...
                    <h1 class="post-title">
                        <a href="{{ route('kelas-detail', $post->slug) }}">{{ $post->post_title; }}</a>
                    </h1>
                ...
                <div class="entry-main-content">
                    ...
                    <div class="social-network">
                        <div class="follow-us d-flex align-items-center">
                            <a class="follow-us-facebook clearfix mr-5 mb-10 w-100" href="https://wa.me/{{ $post->contact }}" target="_blank" style="background: #0a7b0d;">
                    ...
                    <h2>Harga Kelas</h2>
                    <hr class="wp-block-separator is-style-wide">
                    <p>{{ 'Rp. '.number_format($post->price, 0, ",", ".") }}</p>
                ...
                <div class="entry-bottom mt-50 mb-30">
                    <div class="tags">
                        @foreach ($post->tag as $item)
                            <a href="{{ route('course-tag', $item->slug) }}" rel="tag">{{ $item->name; }}</a>
                        @endforeach
                    </div>
                </div>
                <div class="bt-1 border-color-1 mt-30 mb-30"></div>
                ...
                <div class="related-posts">
                    <h3 class="mb-30">Kelas Terkait</h3>
                    <div class="loop-list">
                        @php
                            $related=1;
                        @endphp
                                ...
                                <div class="post-content">
                                    <div class="entry-meta meta-0 font-small mb-15">
                                        ...
                                        @if ($item->sub_categories != NULL)
                                            <a href="{{ route('course-category', $sc->slug) }}">
                                                <span class="post-cat background{{ $related++; }} color-white">
                                                    {{ $sc->name; }}
                                                </span>
                                            </a>
                                        @else
                                            <a href="{{ route('course-category', $item->category->slug) }}">
                                                <span class="post-cat background{{ $related++; }} color-white">
                                                    {{ $item->category->name; }}
                                                </span>
                                            </a>
                ...
                <div class="widget-area pl-30">
                    ...
                    <div class="sidebar-widget widget_alitheme_lastpost mb-50">
                        <div class="widget-header position-relative mb-20 pb-10">
                            <h5 class="widget-title mb-10">Kelas Terbaru</h5>
