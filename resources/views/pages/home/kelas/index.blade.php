...
<div class="archive-header text-center mt-40">
    <div class="container">
        <h2><span class="color2">INFO KELAS</span></h2>
                ...
                <div class="loop-grid row">
                    ...
                    <article class="col-lg-6 mb-50 animate-conner">
                        ...
                        <div class="post-content">
                            ...
                            <h3 class="post-title">
                                <a href="{{ route('kelas-detail', $item->slug) }}">{{ $item->post_title; }}</a>
                            </h3>
                                ...
                                <li class="mb-30">
                                    <div class="d-flex">
                                        <div class="post-thumb d-flex mr-15 border-radius-5 img-hover-scale">
                                            <a href="{{ route('kelas-detail', $latest->slug) }}">
                                        ...
                                        <div class="post-content media-body">
                                            <div class="entry-meta meta-0 mb-10">
                                                ...
                                                @else
                                                    <a href="{{ route('course-category', $latest->category->slug) }}">
                                                        <span class="post-cat background1 color-white">
