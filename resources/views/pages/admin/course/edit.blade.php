                ...
                <div class="page-header-content">
                    <div class="row align-items-center justify-content-between pt-3">
                        ...
                        <div class="col-12 col-xl-auto mb-3">
                            <a class="btn btn-sm btn-light text-primary" href="{{ route('course.index') }}">
                    ...
                    <div class="col-lg-8">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <label for="contact">Narahubung (No. WhatsApp)</label>
                                    <input type="text" class="form-control @error('contact') is-invalid @enderror" value="{{ $item->contact }}" name="contact" placeholder="6282XXXXXX" required>
                                    @error('contact')
                                        <div class="invalid-feedback">
                                            {{ $message; }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    <label for="level">Biaya Kelas</label>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#category').on('change',function(e) {
                ...
                $.ajax({
                    url:"{{ route('get-sub-categories-course') }}",
                    type:"POST",
                    data: {
                        cat_id: cat_id
                    },
