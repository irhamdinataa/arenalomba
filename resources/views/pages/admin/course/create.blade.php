                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('contact') is-invalid @enderror" value="{{ old('contact') }}" name="contact" placeholder="6282XXXXXX" required>
                                    @error('contact')
                                        <div class="invalid-feedback">
                                            {{ $message; }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    <label for="price">Biaya Kelas</label>
