        ...
        <td class="text-center">
            <div class="dropdown">
                ...
                <div class="dropdown-menu animated--fade-in-up" aria-labelledby="dropdownFadeInUp">
                    <a class="dropdown-item" href="{{ route('category.edit', $subcategory->id) }}">Edit</a>
                    <form action="{{ route('category.destroy', $subcategory->id) }}" method="POST" id="deleteForm{{ $subcategory->id }}">
                        @method('delete')
                        @csrf
