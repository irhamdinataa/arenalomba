            ...
            <div class="row">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('apps.update', $item->id) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="mb-3">
                                    <div class="col-md-12">
                                        <label class="small mb-1" for="link_fb">Link Facebook</label>
                                        <input class="form-control @error('link_fb') is-invalid @enderror" name="link_fb" type="link_fb" value="{{ $item->link_fb }}" required/>
                                        @error('link_fb')
                                            <div class="invalid-feedback">
                                                {{ $message; }}
                                            </div>
                                ...
                                <div class="mb-3">
                                    <div class="col-md-12">
                                        <label class="small mb-1" for="link_yt">Link Youtube</label>
                                        <input class="form-control @error('link_yt') is-invalid @enderror" name="link_yt" type="link_yt" value="{{ $item->link_yt }}" required/>
                                        @error('link_yt')
                                            <div class="invalid-feedback">
                                                {{ $message; }}
                                            </div>
                                ...
                                <div class="mb-3">
                                    <div class="col-md-12">
                                        <label class="small mb-1" for="link_ig">Link Instagram</label>
                                        <input class="form-control @error('link_ig') is-invalid @enderror" name="link_ig" type="link_ig" value="{{ $item->link_ig }}" required/>
                                        @error('link_ig')
                                            <div class="invalid-feedback">
                                                {{ $message; }}
                                            </div>
                                ...
                                <div class="mb-3">
                                    <div class="col-md-12">
                                        <label class="small mb-1" for="link_banner">Link Banner</label>
                                        <input class="form-control @error('link_banner') is-invalid @enderror" name="link_banner" type="link_banner" value="{{ $item->link_banner }}" required/>
                                        @error('link_banner')
                                            <div class="invalid-feedback">
                                                {{ $message; }}
                                            </div>
                ...
                <div class="col-xl-5">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            @if (session()->has('success-banner'))
                                <div class="alert alert-success alert-dismissible fade show hide-alert" role="alert">
                                    {{ session('success-banner') }}
                                    <button class="btn-close" type="button" data-bs-dismiss="alert" aria-label="Close"></button>
                                </div>
                            @endif
                            <form action="{{ route('banner-apps.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-12 mb-3">
                                        @if ($item->banner != NULL)
                                            <img id="preview-banner" src="{{ Storage::url($item->banner) }}" class="img-fluid rounded mb-2" alt="Preview Image">
                                        @else
                                            <img id="preview-banner" src="https://placehold.co/700x90" class="img-fluid rounded mb-2" alt="Preview Image">
                                        @endif
                                    </div>
                                    <div class="col-9">
