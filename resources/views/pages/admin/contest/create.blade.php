...
@section('container')
    <main>
                ...
                <div class="page-header-content">
                    <div class="row align-items-center justify-content-between pt-3">
                        ...
                        <div class="col-12 col-xl-auto mb-3">
                            <a class="btn btn-sm btn-light text-primary" href="{{ route('contest.index') }}">
        ...
        <div class="container-fluid px-4">
            ...
            @endif
            <form action="{{ route('contest.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                @csrf
                <div class="row gx-4">
                    <div class="col-lg-8">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3" style="display: none;" id="show_payment">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="price" name="price" value="{{ old('price') }}" placeholder="0000000">
                                        @error('price')
                                            <div class="invalid-feedback">
                                                {{ $message; }}
                                            </div>
