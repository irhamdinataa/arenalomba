...
@section('container')
    <main>
                ...
                <div class="page-header-content">
                    <div class="row align-items-center justify-content-between pt-3">
                        ...
                        <div class="col-12 col-xl-auto mb-3">
                            <a class="btn btn-sm btn-light text-primary" href="{{ route('contest-category.index') }}">
        ...
        <div class="container-fluid px-4">
            ...
            @endif
            <form action="{{ route('contest-category.update', $item->id) }}" method="post" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="row gx-4">
                    <div class="col-lg-8">
