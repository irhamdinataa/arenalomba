                ...
                <div class="page-header-content pt-4">
                    ...
                    <nav class="mt-4 rounded" aria-label="breadcrumb">
                        <ol class="breadcrumb px-3 py-2 rounded mb-0">
                            ...
                            <li class="breadcrumb-item">Lomba</li>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('contest-category.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                        ...
                                        @if ($categories)
                                            @foreach($categories as $category)
                                                ...
                                                @if(count($category->subcategory))
                                                    @include('pages.admin.contest-category.create-sub-category',['subcategories' => $category->subcategory])
                                                @endif
                                            @endforeach
                                        @endif
                                    </select>
                            ...
                            <table class="table table-sm table-striped" id="crudTable">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($categories as $category)
                                            ...
                                            <td class="text-center">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu animated--fade-in-up" aria-labelledby="dropdownFadeInUp">
                                                        <a class="dropdown-item" href="{{ route('contest-category.edit', $category->id) }}">Edit</a>
                                                        <form action="{{ route('contest-category.destroy', $category->id) }}" method="POST" id="deleteForm{{ $category->id }}">
                                                            @method('delete')
                                                            @csrf
                                        ...
                                        @if(count($category->subcategory))
                                            @include('pages.admin.contest-category.list-sub-category',['subcategories' => $category->subcategory])
                                        @endif
                                    @endforeach
                                </tbody>
                            </table>
